...
def COG2024_worker(argument_list):
    ...
    pwd_cog_stats_GeneNumber =                 '%s/%s_cog_stats.txt'               % (current_output_folder, input_seq_no_ext)
    pwd_cog_stats_TotalDepth =                 '%s/%s_cog_stats_depth.txt'               % (current_output_folder, input_seq_no_ext)
    pwd_func_stats_GeneNumber =                '%s/%s_func_stats.txt'              % (current_output_folder, input_seq_no_ext)
    pwd_func_stats_TotalDepth =                '%s/%s_func_stats_depth.txt'              % (current_output_folder, input_seq_no_ext)

    pwd_cog_stats_GeneNumber_pct =             '%s/%s_cog_stats_pct.txt'           % (current_output_folder, input_seq_no_ext)
    pwd_cog_stats_TotalDepth_pct =             '%s/%s_cog_stats_depth_pct.txt'           % (current_output_folder, input_seq_no_ext)
    pwd_func_stats_GeneNumber_pct =            '%s/%s_func_stats_pct.txt'          % (current_output_folder, input_seq_no_ext)
    pwd_func_stats_TotalDepth_pct =            '%s/%s_func_stats_depth_pct.txt'          % (current_output_folder, input_seq_no_ext)

    pwd_cog_stats_GeneNumber_pct_by_all =      '%s/%s_cog_stats_pct_by_all.txt'    % (current_output_folder, input_seq_no_ext)
    pwd_cog_stats_TotalDepth_pct_by_all =      '%s/%s_cog_stats_depth_pct_by_all.txt'    % (current_output_folder, input_seq_no_ext)
    pwd_func_stats_GeneNumber_pct_by_all =     '%s/%s_func_stats_pct_by_all.txt'   % (current_output_folder, input_seq_no_ext)
    pwd_func_stats_TotalDepth_pct_by_all =     '%s/%s_func_stats_depth_pct_by_all.txt'   % (current_output_folder, input_seq_no_ext)
    ...
    for annotation_folder in annotation_folder_list:
        ...
        if stats_level == 'cog_id':
            if with_depth is False:
                ...
                pwd_annotation_stats_file =             '%s/%s/%s_cog_stats_depth.txt'                 % (annotation_dir, annotation_folder, annotation_folder_basename)
                pwd_annotation_stats_file_pct =         '%s/%s/%s_cog_stats_depth_pct.txt'             % (annotation_dir, annotation_folder, annotation_folder_basename)
                pwd_annotation_stats_file_pct_by_all =  '%s/%s/%s_cog_stats_depth_pct_by_all.txt'      % (annotation_dir, annotation_folder, annotation_folder_basename)
        ...
        if stats_level == 'cog_cate':
            if with_depth is False:
                ...
                pwd_annotation_stats_file =             '%s/%s/%s_func_stats_depthh.txt'                % (annotation_dir, annotation_folder, annotation_folder_basename)
...
def COG2024(args):
    ...
    # if input is folder
        ...
        if os.path.isdir(file_in) is False:
            ...
            annotation_df_cog_cate_GeneNumber =             '%s/%s_COG2024_cate.txt'             % (output_folder, file_in_folder_name)
            annotation_df_cog_cate_GeneNumber_pct =         '%s/%s_COG2024_cate_pct.txt'         % (output_folder, file_in_folder_name)
            annotation_df_cog_cate_GeneNumber_pct_by_all =  '%s/%s_COG2024_cate_pct_by_all.txt'  % (output_folder, file_in_folder_name)
            annotation_df_cog_cate_TotalDepth =             '%s/%s_COG2024_cate_depth.txt'             % (output_folder, file_in_folder_name)
            annotation_df_cog_cate_TotalDepth_pct =         '%s/%s_COG2024_cate_depth_pct.txt'         % (output_folder, file_in_folder_name)
            annotation_df_cog_cate_TotalDepth_pct_by_all =  '%s/%s_COG2024_cate_depth_pct_by_all.txt'  % (output_folder, file_in_folder_name)
            annotation_df_cog_id_GeneNumber =               '%s/%s_COG2024_id.txt'               % (output_folder, file_in_folder_name)
            annotation_df_cog_id_GeneNumber_pct =           '%s/%s_COG2024_id_pct.txt'           % (output_folder, file_in_folder_name)
            annotation_df_cog_id_GeneNumber_pct_by_all =    '%s/%s_COG2024_id_pct_by_all.txt'    % (output_folder, file_in_folder_name)
            annotation_df_cog_id_TotalDepth =               '%s/%s_COG2024_id_depth.txt'               % (output_folder, file_in_folder_name)
            annotation_df_cog_id_TotalDepth_pct =           '%s/%s_COG2024_id_depth_pct.txt'           % (output_folder, file_in_folder_name)
            annotation_df_cog_id_TotalDepth_pct_by_all =    '%s/%s_COG2024_id_depth_pct_by_all.txt'    % (output_folder, file_in_folder_name)

...
# Example commands
BioSAK get_genome_NCBI -csv prokaryotes.csv -out gnm_dir -fna -name -t 8
BioSAK get_genome_NCBI -csv prokaryotes.csv -out gnm_dir -fna -faa -name -t 8
BioSAK get_genome_NCBI -csv prokaryotes.csv -id ids.txt -out gnm_dir -fna -gbff -name -t 8 

# id file format (the 6th col of the downloaded csv file, one id per line)
GCA_009840555.1
GCA_009840575.1

...
if __name__ == '__main__':
    ...
    link_16S_and_MAG_parser.add_argument('-cigarM', required=False, type=int, default=30,    help='cigarM cutoff, default: 50')
    link_16S_and_MAG_parser.add_argument('-cigarS', required=False, type=int, default=30,    help='cigarS cutoff, default: 50')
    ...
    args['run_mapping'] = False
    args['run_blastn']  = False
...
cd /Users/songweizhi/Desktop/link_16S_MAG/2R2
python3 ~/PycharmProjects/BioSAK/BioSAK/link_16S_MAG_v2.py -p 2R2 -r1 2R2_R1_Q30_P_renamed.fasta -r2 2R2_R2_Q30_P_renamed.fasta -m AllSamples_denoised.fasta -mag Refined_bins -x fasta -t 4

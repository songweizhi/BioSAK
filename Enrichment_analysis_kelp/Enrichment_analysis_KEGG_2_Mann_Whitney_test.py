...
# file in
ko_level = 'D'  # B, C, D
csv_file =      '/Users/songweizhi/Desktop/enrichment_analysis/KEGG_%s_enrichment_analysis.csv'                 % ko_level
...
output_test_handle.write('KO\tKelp\tDectected_pct\tPlanktonic\tDectected_pct\tP_value\tP_value_adjusted\n')

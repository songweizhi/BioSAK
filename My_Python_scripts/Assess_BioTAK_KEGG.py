...
# local_ko =      '/Users/songweizhi/Desktop/Assess_BioTAK/KEGG/BH_ER_050417_Refined_%s_KO_assignment_D_BlastKOALA.txt' % MAG_id
# GhostKOALA_ko = '/Users/songweizhi/Desktop/Assess_BioTAK/KEGG/BH_ER_050417_Refined_%s_KO_assignment_D_GhostKOALA.txt' % MAG_id

local_ko =      '/Users/songweizhi/Desktop/Assess_BioTAK/KEGG/BH_ER_050417_Refined_%s_KO_assignment_D_BioSAK_Blast.txt'    % MAG_id
GhostKOALA_ko = '/Users/songweizhi/Desktop/Assess_BioTAK/KEGG/BH_ER_050417_Refined_%s_KO_assignment_D_BioSAK_Diamond.txt'  % MAG_id
...
print(both_NA_num)
print(same_ko_num)
print(different_ko_num)
print(only_local_num)
print(only_ghost_num)

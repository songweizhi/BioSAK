...
# Rscript ~/R_scripts/for_plot/COG_summary_boxplot_last1row.R -i matrix.csv -o plot.png
...
plot_width = col_num*0.25
plot_height = col_num*0.15
png(filename=opt$out, units="in", width=plot_width, height=plot_height, pointsize=10, res=300)
...
ggplot() + 
  ...
  theme(panel.border = element_blank(), 
        ...
        axis.text.x = element_text(colour="black",size=12,angle=270,hjust=0,vjust=0.5,face="plain"),
        axis.text.y = element_text(colour="black",size=12,angle=0,hjust=0,vjust=0,face="plain"),

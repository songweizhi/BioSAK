...
png(filename=opt$out, units="in", width=10, height=5, pointsize=10, res=300)
...
ggplot() + 
  ...
  theme(panel.border = element_blank(), 
        ...
        axis.text.x = element_text(colour="black",size=12,angle=0,hjust=.5,vjust=.5,face="plain",angle=-90),

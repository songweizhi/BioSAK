...
+ You can get the help information and example commands by typing `BioSAK [module name] -h`, for example:
    
      BioSAK iTOL -h
      BioSAK select_seq -h
      BioSAK get_GTDB_taxon_gnm -h
...
+ Type `BioSAK -h` to see a full list of modules
    ...
    Sequence/reads manipulator
       ...
       rm_desc                 ->  Remove sequence descriptions
       rm_short                ->  Remove short sequences

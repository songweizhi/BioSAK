...
png(filename=opt$out, units="in", width=10, height=20, pointsize=10, res=300)
...
ggplot() + 
  ...
  theme(panel.border = element_blank(), 
        ...
        axis.text.x = element_text(colour="black",size=10,angle=-90,hjust=0,vjust=0,face="plain"),

...
sam2reads_usage = '''
========================== sam2reads example commands ==========================

module load samtools/1.15
BioSAK sam2reads -b sorted.bam -o sam2reads_wd_ctg1 -r contig_1 -s Reads.fastq
BioSAK sam2reads -b sorted.bam -o sam2reads_wd_ctg2 -r contig_2:2000-5000
BioSAK sam2reads -b sorted.bam -o sam2reads_wd_ctg3 -r contig_3:2000-
BioSAK sam2reads -b sorted.bam -o sam2reads_wd_ctg4 -r contig_4:-5000 
